...
new = read_tsv("~/.gvpers/Occupations.tsv") %>% filter(!is.na(workPositionName))
...
manualReplacement = read_xlsx("~/.gvpers/manuallyRenamed.xlsx")
...
table(leidur(new$new, "asetäitja", "juhi"))
new$new = asendaja(new$new, "juhi", "asetäitja", excl1 = "finantsjuht", replace = "juhiasetäitja")
new$new = asendaja(new$new, "juhataja", "asetäitja", replace = "juhiasetäitja")
new$new = asendaja(new$new, "juhataja", "kohusetäitja", excl1 = "hooldaja", replace = "juhiasetäitja")
new$new = asendaja(new$new, "juhi", "kohusetäitja", replace = "juhiasetäitja")
new$new = asendaja(new$new, "kpljuhatasetäitja", "", replace = "juhiasetäitja")
...
new$new = asendaja(new$new, "^õendustöökoordineerija$","", replace = "meditsiiniõde")
...
new$new = asendaja(new$new, "^auditijuht$", "", replace = "pearaamatupidaja")
...
new$new = asendaja(new$new, "tootmisekordin", "", replace = "tootmistöödejuhataja")
...
new$new = asendaja(new$new, "^kõrgemametnik$", "", replace = "kõrgem valitsusametnik")
...
new$new = asendaja(new$new, "^businessanalyst$", "", replace = "süsteemianalüütik")
...
new$new = asendaja(new$new, "keelespetsialist", "", replace = "filoloog")
...
new$new = asendaja(new$new, "avalikteenistuja", "", replace = "riigiametnik")
...
new$new = asendaja(new$new, "tootespetsalist", "", replace = "müügiesindaja")
...
new$new = asendaja(new$new, "^riskianalüütik$", "", replace = "finantsanalüütik")
new$new = asendaja(new$new, "^underwriter$", "", replace = "finantsanalüütik")
new$new = asendaja(new$new, "^krediidiriskimodelleerija$", "", replace = "finantsanalüütik")
new$new = asendaja(new$new, "^laenuotsustaja$", "", replace = "finantsanalüütik")
...
new$new = asendaja(new$new, "^sektsiooniülem$", "", replace = "sõjaväelane")
new$new = asendaja(new$new, "^malevapealik$", "", replace = "sõjaväelane")
...
new$new = asendaja(new$new, "koduteenuse", "", replace = "hooldaja")
...
new$new = asendaja(new$new, "ventilatsioonitehnik", "", replace = "torulukksepp")
...
new$new = asendaja(new$new, "^reisijuht", "", replace = "giid")
...
new$new = asendaja(new$new, "pitsameister", "", replace = "kokk")
...
new$new = asendaja(new$new, "^laohoiukohaspetsialist$", "", replace = "laoametnik")
...
new$new = asendaja(new$new, "^ppaspetsialist", "", replace = "tolliinspektor")
...
new$new = asendaja(new$new, "metsaparandaja", "", replace = "metsandustehnik")
...
new$new = asendaja(new$new, "^telgimeister", "", replace = "õmbleja")
new$new = asendaja(new$new, "^tõmblukuvalmistaja", "", replace = "õmbleja")
...
new$new = asendaja(new$new, "^väljapanekutejuht$", "", replace = "sisekujundaja")
...
new$new = asendaja(new$new, "liikluskorraldaja", "", replace = "logistik")
...
new$new = asendaja(new$new, "nõrkvoolusüsteemidespetsialist", "", replace = "elektrotehnik")
new$new = asendaja(new$new, "turvasüsteemidespetsialist", "", replace = "elektrotehnik")
new$new = asendaja(new$new, "^käidukorraldaja$", "", replace = "elektrotehnik")
...
new$new = asendaja(new$new, "^varudejuht$", "", replace = "hankespetsialist")
...
new$new = asendaja(new$new, "^ostukordinaator$", "", replace = "hankespetsialist")
...
new$new = asendaja(new$new, "metallitsehh", "meister", replace = "metallimasinaoperaator")
...
new$new = asendaja(new$new, "^tootmisoperaator$", "", replace = "masinaoperaator")
new$new = asendaja(new$new, "^kütja$", "", replace = "masinaoperaator")
...
new$new = asendaja(new$new, "notariabi", "",  replace = "õigusekeskastmespetsialist")
new$new = asendaja(new$new, "täitemenetlusehaldur", "",  replace = "õigusekeskastmespetsialist")
...
new$new = asendaja(new$new, "materjaliplaneerija", "", replace = "hankespetsialist")
new$new = asendaja(new$new, "^categorymanager$", "", replace = "hankespetsialist")
...
new$new = asendaja(new$new, "^tehnilinetestija$", "", replace = "it-testija")
...
new$new = asendaja(new$new, "^personalikonsultant$", "", replace = "personalispetsialist")
...
new$new = asendaja(new$new, "küsitlusjuht", "", replace = "kontorijuhataja")
...
new$new = asendaja(new$new, "^meediasuhetejuht$", "", replace = "kommunikatsioonijuht")
...
new$new = asendaja(new$new, "^ärinõustaja$", "", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "^businessdevelopmentmanager$", "", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "^businessprocesslead$", "", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "^processmanager$", "", replace = "juhtimisanalüütik")
...
new$new = asendaja(new$new, "taluperemees", "", replace = "põllumajandustöötaja")
new$new = asendaja(new$new, "taluperenaine", "", replace = "põllumajandustöötaja")
...
new$new = asendaja(new$new, "^projekteeria$", "", replace = "projekteerija")
...
new$new = asendaja(new$new, "trafodevalmistaja", "", replace = "elektriseadmete koostaja")
...
new$new = asendaja(new$new, "^montöör$", "", replace = "muudkoostajad")
...
new$new = asendaja(new$new, "töökaitsespetsialist", "", replace = "töökeskkonnaspetsialist")

unique(leidur(new$new, "keskkonna", "spets"))
new$new = asendaja(new$new, "veespetsialist", "", replace = "valitsuse haldusalade ametnik")
...
new$new = asendaja(new$new, "^contentmanager$", "", replace = "reklaamispetsialist")
new$new = asendaja(new$new, "kliendikogemusespetsialist", "", replace = "reklaamispetsialist")

#new$new = asendaja(new$new, "kliendikogemu", "juht", replace = "reklaamispetsialist")
new$new = asendaja(new$new, "kliendikogemu", "juht", replace = "teenustejuht")
...
new$new = asendaja(new$new, "termotöötleja", "", replace = "puidutööline")
...
new$new = asendaja(new$new, "^teritaja$", "", replace = "metallitööline")
...
new$new = asendaja(new$new, "toidujagaja", "", replace = "köögiabiline")
...
new$new = asendaja(new$new, "^ennetustööspetsialist$", "", replace = "sotsiaaltööspetsialist")
new$new = asendaja(new$new, "^sotsiaalkonsultant$", "", replace = "sotsiaaltööspetsialist")
...
new$new = asendaja(new$new, "lennuspetsialist", "", replace = "lennujuht")
...
new$new = asendaja(new$new, "^valgusmeister$", "", replace = "muu kultuurivaldkonna spetsialist")
new$new = asendaja(new$new, "^valgustaja$", "", replace = "muu kultuurivaldkonna spetsialist")
...
new$new = asendaja(new$new, "backofficespetsialist", "", replace = "kontoritöötaja")
new$new = asendaja(new$new, "^kontoritöö$", "", replace = "kontoritöötaja")
new$new = asendaja(new$new, "administrat", "spetsialist", replace = "kontoritöötaja")
new$new = asendaja(new$new, "^administratiivtöötaja$", "", replace = "kontoritöötaja")
...
new$new = asendaja(new$new, "^majandustööline$", "", replace = "puhastusteenindaja")
...
new$new = asendaja(new$new, "^accountingmanager$", "", replace = "pearaamatupidaja")
...
new$new = asendaja(new$new, "raamarupidaja", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamatuoidaja", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamatupdaja", "", replace = "raamatupidaja")
...
new$new = asendaja(new$new, "^juhatuseesinaine$", "", replace = "juht")
...
new$new = asendaja(new$new, "õhusõidukiteenindusespetsialist", "", replace = "lennukimehaanik")
...
new$new = asendaja(new$new, "^müüginõustaja$", "", replace = "müüja")
new$new = asendaja(new$new, "^uuskasutusspetsialist$", "", replace = "müüja")
...
new$new = asendaja(new$new, "äri", "juh", excl1 = "arendus", excl2 = "müügi", excl3 = "tiimijuht", replace = "haldusjuht")
...
new$new = asendaja(new$new, "komandopealik", "", replace = "kutseteenustejuht")
...
new$new = asendaja(new$new, "segmendijuht", "", replace = "osakonnajuhataja")
...
new$new = asendaja(new$new, "projektidejuhtimine", "", replace = "projektijuht")
...
new$new = asendaja(new$new, "^sündmustejuht$", "", replace = "üritustekorraldaja")
...
new$new = asendaja(new$new, "ruumilisekeskkonnaplaneerija", "", replace = "linnaplaneerija")
new$new = asendaja(new$new, "ruumilineplaneerija", "", replace = "linnaplaneerija")
new$new = asendaja(new$new, "liiklusspetsialist", "", replace = "linnaplaneerija")
...
new$new = asendaja(new$new, "^administratiivabi$", "", replace = "juhiabi")
...
new$new = asendaja(new$new, "^ettevüttejuht$", "",  replace = "ettevõttejuht")
...
new$new = asendaja(new$new, "teenustejuht", "", excl1 = "tervishoiu", excl2 = "kutse", excl3 = "tugi", excl4 = "kultuuri", replace = "teenustejuht")
...
new$new = asendaja(new$new, "tootmis", "plan", excl1 = "müügi", excl2 = "materjali", replace = "tootmistöödejuhataja")
...
new$new = asendaja(new$new, "kinnisvaraarendaja", "", replace = "ehitustöödejuhataja")
...
new$new = asendaja(new$new, "objektivanem", "", replace = "töödejuhataja")
...
new$new = asendaja(new$new, "kultuur", "juh", excl1 = "programm", excl2 = "valdkon", excl3 = "ameti", excl4 = "teenuste", replace = "vabaajakeskustejuht")
...
new$new = asendaja(new$new, "hotellivastuvõtujuht", "", replace = "osakonnajuhataja")
...
new$new = asendaja(new$new, "complianceofficer", "", replace = "jurist")
...
new$new = asendaja(new$new, "^teenistusjuht$", "", replace = "kontorijuhataja")
...
new$new = asendaja(new$new, "juh", "investorsuhete", replace = "finantsjuht")
...
new$new = asendaja(new$new, "^rahaasjadeteabekeskusejuht$", "", replace = "teenustejuht")
...
new$new = asendaja(new$new, "järelevalveinsener", "", replace = "ehitustehnik")
...
new$new = asendaja(new$new, "^cpo$", "", replace = "hankejuht")
...
new$new = asendaja(new$new, "emailija", "", replace = "juveelitöötleja")
...
new$new = asendaja(new$new, "^tööinspektor$", "", replace = "valitsuse haldusalade ametnik")
new$new = asendaja(new$new, "^kovametnik$", "", replace = "valitsuse haldusalade ametnik")
...
new$new = asendaja(new$new, "maksuhaldur", "", replace = "maksuametnik")
...
new$new = asendaja(new$new, "jõudluskontrollispetsialist", "", replace = "põllumajandustehnik")
new$new = asendaja(new$new, "puittaimedehindaja", "", replace = "metsatööline")
...
new$new = asendaja(new$new, "^markeerija$", "", replace = "pakkija")
...
new$new = asendaja(new$new, "^meistriabi$", "", replace = "tööstuselihttööline")
...
new$new = asendaja(new$new, "sideinsener", "", replace = "telekommunikatsiooniinsener")
...
new$new = asendaja(new$new, "sideoperaator", "", replace = "telekommunikatsioonitehnik")
...
new$new = asendaja(new$new, "arvutitestija", "", replace = "toodetetestija")
new$new = asendaja(new$new, "kummidetailidekontrollija", "", replace = "toodetetestija")
...
new$new = asendaja(new$new, "tootearendus", "insener", "", replace = "tööstusinsener")
...
new$new = asendaja(new$new, "väärtpaberihaldusespetsialist", "", replace = "valuutamaakler")
...
new$new = asendaja(new$new, "senioranalyst", "", replace = "analüütik")
...
new$new = asendaja(new$new, "^aruandlusspetsialist$", "", replace = "spetsialist")
...
new$new = asendaja(new$new, "turustusabi", "", replace = "müügiesindaja")
...
new$new = asendaja(new$new, "^müügianalüütik$", "", replace = "müügiesindaja")
new$new = asendaja(new$new, "^brändikonsultant$", "", replace = "müügiesindaja")
new$new = asendaja(new$new, "^müügiagent$", "", replace = "müügiesindaja")
new$new = asendaja(new$new, "^müügikordinaator$", "", replace = "müügiesindaja")
...
new$new = asendaja(new$new, "konsultant-nõustaja", "", replace = "konsultant")
new$new = asendaja(new$new, "tööandjatekonsultant", "", replace = "konsultant")
new$new = asendaja(new$new, "aruandluskonsultant", "", replace = "konsultant")
new$new = asendaja(new$new, "cashmanagementkonsultant", "", replace = "konsultant")
new$new = asendaja(new$new, "haldur-konsultant", "", replace = "konsultant")
new$new = asendaja(new$new, "programmikonsultant", "", replace = "konsultant")
...
new$new = asendaja(new$new, "^teenindusspetsialist", "", replace = "teenindaja")
new$new = asendaja(new$new, "^teeninduskonsultant", "", replace = "teenindaja")
...
new$new = asendaja(new$new, "developer", "", replace = "arendaja")
...
new$new = asendaja(new$new, "tsehhimeister", "", replace = "meister")
new$new = asendaja(new$new, "vahetusmeister", "", replace = "meister")
...
new$new = asendaja(new$new, "komponendiinsener", "", replace = "insener")
...
new$new = asendaja(new$new, "avalikusektoriametnik", "", replace = "ametnik")
...
new$new = asendaja(new$new, "^tegevabi$", "", replace = "juhiabi")
new$new = asendaja(new$new, "^tootmiseabi$", "", replace = "juhiabi")
...
new$new = asendaja(new$new, "^tehnik-mehaanik$", "", replace = "tehnik")
new$new = asendaja(new$new, "^tehnik-mehhaanik$", "", replace = "tehnik")
new$new = asendaja(new$new, "^vanemtehnik$", "", replace = "tehnik")
new$new = asendaja(new$new, "^katsetehnik$", "", replace = "tehnik")
new$new = asendaja(new$new, "^paigaldustehnik$", "", replace = "tehnik")
new$new = asendaja(new$new, "^seiretehnik$", "", replace = "tehnik")
...
new$new = asendaja(new$new, "^dokumentidekäsitleja$", "", replace = "registripidaja")
new$new = asendaja(new$new, "^hoiuhaldur$", "", replace = "registripidaja")
...
new$new = asendaja(new$new, "^rahvastikutoimingutespetsialist$", "", replace = "jurist-asjaajaja")
...
new$new = asendaja(new$new, "^osakonnaülem$", "", replace = "osakonnajuhataja")
...
new$new = asendaja(new$new, "^vahetusemeister$", "", replace = "meister")
new$new = asendaja(new$new, "^vahetuseülem$", "", replace = "vahetusevanem")
new$new = asendaja(new$new, "^oskustööline.$", "", replace = "oskustööline")

new$new = asendaja(new$new, "^ravimiesitleja", "", replace = "tehnilinemüügiesindaja")
new$new = asendaja(new$new, "ravim", "konsultant", replace = "tehnilinemüügiesindaja")
new$new = asendaja(new$new, "tootespetsialistravimitealal", "", replace = "tehnilinemüügiesindaja")
new$new = asendaja(new$new, "ravimiesindaja", "", replace = "tehnilinemüügiesindaja")
new$new = asendaja(new$new, "müügitehnik", "", replace = "tehnilinemüügiesindaja")

new$new = asendaja(new$new, "^specialist$", "", replace = "spetsialist")
new$new = asendaja(new$new, "^projektidespetsialist$", "", replace = "spetsialist")
new$new = asendaja(new$new, "^kovspetsialist$", "", replace = "spetsialist")
new$new = asendaja(new$new, "^programmispetsialist$", "", replace = "spetsialist")
new$new = asendaja(new$new, "^seirespetsialist$", "", replace = "spetsialist")
new$new = asendaja(new$new, "^spetsialistfinantsasutuses$", "", replace = "spetsialist")
new$new = asendaja(new$new, "^verificationspecialist$", "", replace = "spetsialist")
new$new = asendaja(new$new, "^verifikatsioonispetsialist$", "", replace = "spetsialist")

new$new = asendaja(new$new, "^seniorexpert$", "", replace = "peaspetsialist")
...
new$new = asendaja(new$new, "^medtöötaja$", "", replace = "meditsiinitöötaja")

new$new = asendaja(new$new, "teenindaja-", "", replace = "teenindaja")
new$new = asendaja(new$new, "teenindustöötaja", "", replace = "teenindaja")
...
new$new = asendaja(new$new, "krupjee", "",  replace = "kasiinodiiler")
...
new$new = asendaja(new$new, "veebipoeadministraator", "",  replace = "IKT-tehnik")
new$new = asendaja(new$new, "helpdeskmanager", "",  replace = "IKT-tehnik")
new$new = asendaja(new$new, "masterdataspetsialist", "", replace = "IKT-tehnik")

new$new = asendaja(new$new, "kosmeetikavalmistaja", "",  replace = "keemiatoodetevalmistaja")
new$new = asendaja(new$new, "separeerija", "",  replace = "keemiatoodetevalmistaja")
new$new = asendaja(new$new, "tarrendtoodetevalmistaja", "",  replace = "toiduainetöötleja")
new$new = asendaja(new$new, "toiduainetetöötleja", "",  replace = "toiduainetöötleja")
new$new = asendaja(new$new, "toidukäitleja", "",  replace = "toiduainetöötleja")
...
new$new = asendaja(new$new, "vahetusjuht", "",  replace = "vahetusevanem")
new$new = asendaja(new$new, "vahetusvanem", "",  replace = "vahetusevanem")
...
new$new = asendaja(new$new, "^kvaliteedikontroll", "", excl1 = "juht", replace = "toodetetestija")
new$new = asendaja(new$new, "^kvaliteedikontrolör", "", excl1 = "juht", replace = "toodetetestija")
new$new = asendaja(new$new, "vanemtestija", "", replace = "testija")

new$new = asendaja(new$new, "^puurmeister", "", replace = "puurija")

new$new = asendaja(new$new, "tootejuht", "", replace = "tootejuht")
new$new = asendaja(new$new, "tootegrupijuht", "", replace = "tootejuht")
new$new = asendaja(new$new, "tooterühmajuht", "", replace = "tootejuht")
...
new$new = asendaja(new$new, "accountmanager", "", replace = "kontohaldur")

new$new = asendaja(new$new, "chiefoper", "offic",  replace = "juht")
new$new = asendaja(new$new, "^coo$", "",  replace = "juht")
new$new = asendaja(new$new, "^esindusejuht$", "",  replace = "juht")
new$new = asendaja(new$new, "^organisatsioonijuht$", "",  replace = "juht")
new$new = asendaja(new$new, "^kõrgemametnikjuht$", "",  replace = "juht")
new$new = asendaja(new$new, "^president$", "",  replace = "juht")
new$new = asendaja(new$new, "^muudatustejuht$", "",  replace = "juht")
...
new$new = asendaja(new$new, "^tehnikaspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^transpordispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^leanspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^garantiispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^varuosadespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^pangaspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^e-kaubandusespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^teabespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^tootmisespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^eriosadespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^tugispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^uuringuspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^riskikontrollispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^materjalispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^masterdataspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^järelteenindusespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^tellimustespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^spetsialistpangas$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^riketehaldusespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^ohutusspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^arenguspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^kohtuspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^kaubandusspetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^kontrollispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^arvutispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^protsessispetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^varahaldusespetsialist$", "",  replace = "spetsialist")
new$new = asendaja(new$new, "^toitlustusspetsialist$", "",  replace = "spetsialist")
...
new$new = asendaja(new$new, "kliendianalüütik", "",  replace = "analüütik")
new$new = asendaja(new$new, "tootmiseanalüütik", "",  replace = "analüütik")
new$new = asendaja(new$new, "tooteanalüütik", "",  replace = "analüütik")
new$new = asendaja(new$new, "protsessianalüütik", "",  replace = "analüütik")
new$new = asendaja(new$new, "kuluanalüütik", "",  replace = "analüütik")

new$new = asendaja(new$new, "pangaametnik", "",  replace = "ametnik")
new$new = asendaja(new$new, "konsulaarametnik", "",  replace = "ametnik")

new$new = asendaja(new$new, "majanduskoordinaator", "",  replace = "koordinaator")
new$new = asendaja(new$new, "programmikoordinaator", "",  replace = "koordinaator")
new$new = asendaja(new$new, "produktsioonikoordinaator", "",  replace = "koordinaator")
new$new = asendaja(new$new, "treeningutekoordinaator", "",  replace = "koordinaator")
new$new = asendaja(new$new, "fotokoordinaator", "",  replace = "koordinaator")
...
new$new = asendaja(new$new, "^regioonikoordinaator$", "",  replace = "koordinaator")
new$new = asendaja(new$new, "^kategooriakoordinaator$", "",  replace = "koordinaator")
...
new$new = asendaja(new$new, "^oskustööline$", "",  replace = "meister")
new$new = asendaja(new$new, "^tootmisspetsialist$", "",  replace = "meister")
...
new$new = asendaja(new$new, "projektikoordinaator", "",  replace = "projektijuht")
new$new = asendaja(new$new, "programmijuht", "",  replace = "projektijuht")
...
new$new = asendaja(new$new, "tootehaldur", "",  replace = "tootejuht")
...
new$new = asendaja(new$new, "^haldus$", "",  replace = "haldur")

new$new = asendaja(new$new, "^grupijuht", "", replace = "tiimijuht")
new$new = asendaja(new$new, "^kliendinõustaja", "", replace = "klienditeenindaja")
new$new = asendaja(new$new, "^testija$", "", replace = "kvaliteedispetsialist")
new$new = asendaja(new$new, "^dispetšer$", "", replace = "logistik")
new$new = asendaja(new$new, "^viimistleja$", "", replace = "ehitusviimistleja")
new$new = asendaja(new$new, "^tehnilinekonsultant$", "", replace = "konsultant")
new$new = asendaja(new$new, "^menetleja$", "", replace = "ametnik")
new$new = asendaja(new$new, "^tootearendusspetsialist$", "", replace = "tootearendaja")
new$new = asendaja(new$new, "^meeskonnavanem$", "", replace = "tiimijuht")
new$new = asendaja(new$new, "^järeltöötleja$", "", replace = "muulihttööline")
new$new = asendaja(new$new, "^qamanager$", "", replace = "kvaliteedijuht")
new$new = asendaja(new$new, "^prorektor$", "", replace = "juht")
new$new = asendaja(new$new, "^liinijuht$", "", replace = "meister")
new$new = asendaja(new$new, "^liinivanem$", "", replace = "meister")
new$new = asendaja(new$new, "^tellimustekäsitleja$", "", replace = "laoametnik")
new$new = asendaja(new$new, "^privaatpankur$", "", replace = "finantsnõustaja")
new$new = asendaja(new$new, "^mentor$", "", replace = "superviisor")
new$new = asendaja(new$new, "^purser", "", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "^customerproductionofficer", "", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "^servicedeskexpert", "", replace = "klienditoe konsultant")

new$new = asendaja(new$new, "^planeerija$", "", replace = "tootmistöödejuhataja")
new$new = asendaja(new$new, "^seadistaja$", "", replace = "masinaoperaator")
new$new = asendaja(new$new, "^kontroller$", "", replace = "pearaamatupidaja")
new$new = asendaja(new$new, "^teenusedisainer$", "", replace = "strateegiateväljatöötaja")
new$new = asendaja(new$new, "^muuseumitöötaja$", "", replace = "klienditeenindaja")
new$new = asendaja(new$new, "^lihvija$", "", replace = "ehitusviimistleja")
new$new = asendaja(new$new, "^liimija$", "", replace = "muulihttööline")
new$new = asendaja(new$new, "^operatiivjuht$", "", replace = "juht")
new$new = asendaja(new$new, "^tehnikahooldusjuht$", "", replace = "masinaehitustehnik")
new$new = asendaja(new$new, "^diagnostik$", "", replace = "masinaehitustehnik")
new$new = asendaja(new$new, "^ema$", "", replace = "koduperenaine")
new$new = asendaja(new$new, "^cad$", "", replace = "joonestaja")
new$new = asendaja(new$new, "^karjabrigadir$", "", replace = "põllumajandustöötaja")
new$new = asendaja(new$new, "^korraldusjuht$", "", replace = "üritustekorraldaja")
new$new = asendaja(new$new, "^kyc$", "", replace = "strateegiateväljatöötaja")
new$new = asendaja(new$new, "^levijuht$", "", replace = "müügijuht")
new$new = asendaja(new$new, "^maajuht$", "", replace = "juht")
new$new = asendaja(new$new, "^operationscoordinator$", "", replace = "koordinaator")
new$new = asendaja(new$new, "^pens", "", replace = "pensionär")
new$new = asendaja(new$new, "^töövõimet", "", replace = "töövõimetuspensionär")
new$new = asendaja(new$new, "^ravimiuuringuteassistent", "", replace = "juhiabi")
new$new = asendaja(new$new, "uuring", "juh", replace = "uuringujuht")
new$new = asendaja(new$new, "autodetailer", "", replace = "autopesija")
new$new = asendaja(new$new, "autodemüügieelneettevalmistaja", "", replace = "autopesija")

new$new = asendaja(new$new, "groomer", "", replace = "loomahooldaja")
new$new = asendaja(new$new, "kasutajatugi", "", replace = "IKT-tehnik")
new$new = asendaja(new$new, "tehnilineabi", "", replace = "juhiabi")
new$new = asendaja(new$new, "preanalüütikavastutavabi", "", replace = "muu tervishoiuhooldustöötaja")
new$new = asendaja(new$new, "superintendant", "", replace = "masinaehitustehnik")
new$new = asendaja(new$new, "süsteemioperaator", "", replace = "masinaoperaator")
new$new = asendaja(new$new, "automaatikagrupijuht", "", replace = "tootmistöödejuhataja")
new$new = asendaja(new$new, "tehnilinenõustaja", "", replace = "konsultant")
new$new = asendaja(new$new, "tehnilinetoimetaja", "", replace = "toimetaja")
new$new = asendaja(new$new, "tugiüksusejuht", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "teadusliktöötaja", "", replace = "teadustöötaja")
new$new = asendaja(new$new, "meditsiinivelsker", "", replace = "meditsiinitöötaja")
new$new = asendaja(new$new, "kliinilisteravimiuuringutemonitoorija", "", replace = "meditsiinitöötaja")

new$new = asendaja(new$new, "vastuvõtujuht", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "üürisuhetejuht", "", replace = "reklaamispetsialist")
new$new = asendaja(new$new, "technicalsuccessmanager", "", replace = "reklaamispetsialist")
new$new = asendaja(new$new, "tõlkekorraldaja", "", replace = "koordinaator")
new$new = asendaja(new$new, "technicalsupportmanager", "", replace = "tööstusjuht")
new$new = asendaja(new$new, "sisuloomejuht", "", replace = "reklaamijuht")
new$new = asendaja(new$new, "reklaamtoodetevalmistaja", "", replace = "muudkoostajad")
new$new = asendaja(new$new, "regulaatorsuhetejuht", "", replace = "strateegiateväljatöötaja")
new$new = asendaja(new$new, "protokollijuht", "", replace = "kommunikatsioonispetsialist")
new$new = asendaja(new$new, "peretöötaja", "", replace = "sotsiaaltööspetsialist")
new$new = asendaja(new$new, "projectplanningmanager", "", replace = "projektijuht")
new$new = asendaja(new$new, "projektinõustaja", "", replace = "konsultant")
new$new = asendaja(new$new, "pruulmeister", "", replace = "toiduainemasinaoperaator")
new$new = asendaja(new$new, "fondiadministraator", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "^nõustaja$", "", replace = "konsultant")
new$new = asendaja(new$new, "^doktorant$", "", replace = "teadustöötaja")
new$new = asendaja(new$new, "^tooteomanik$", "", replace = "tootejuht")
new$new = asendaja(new$new, "^engineeringmanager$", "", replace = "tootejuht")

new$new = asendaja(new$new, "^restauraator$", "", replace = "tisler")
new$new = asendaja(new$new, "^ohutusjuht$", "", replace = "töökeskkonnaspetsialist")
new$new = asendaja(new$new, "^poliitik$", "", replace = "seadusandja")
new$new = asendaja(new$new, "^disainijuht$", "", replace = "disainer")
new$new = asendaja(new$new, "uuringujuht", "", replace = "teadustöötaja")
new$new = asendaja(new$new, "pangatöötaja", "", replace = "pangateller")
new$new = asendaja(new$new, "riskihaldur", "", replace = "spetsialist")
new$new = asendaja(new$new, "sisulooja", "", replace = "müügiesindaja")
new$new = asendaja(new$new, "tööandja", "", replace = "juht")
new$new = asendaja(new$new, "asutaja", "", replace = "ettevõtja")
new$new = asendaja(new$new, "mehhanismijuht", "", replace = "masinajuht")
new$new = asendaja(new$new, "vabakutselineloovisik", "", replace = "artist")
new$new = asendaja(new$new, "^tööline$", "", replace = "abitööline")
new$new = asendaja(new$new, "^mängudeesitleja$", "", replace = "kasiinodiiler")
new$new = asendaja(new$new, "^koolitusabi$", "", replace = "juhiabi")
new$new = asendaja(new$new, "^pesutöötleja$", "", replace = "pesupesija")

new$new = asendaja(new$new, "supportengineer", "", replace = "insener")
new$new = asendaja(new$new, "hooldusinsener", "", replace = "insener")
new$new = asendaja(new$new, "arendusinsener", "", replace = "insener")
new$new = asendaja(new$new, "võrguinsener", "", replace = "insener")

new$new = asendaja(new$new, "kaubandustöötaja", "", replace = "muukaubandustöötaja")
new$new = asendaja(new$new, "müük", "", replace = "muukaubandustöötaja")
new$new = asendaja(new$new, "^kaubandus$", "", replace = "muukaubandustöötaja")
new$new = asendaja(new$new, "^kaubanduses$", "", replace = "muukaubandustöötaja")
new$new = asendaja(new$new, "kaupleja", "", replace = "muukaubandustöötaja")

new$new = asendaja(new$new, "vanemhooldusnõunik", "", replace = "hooldusnõunik")
new$new = asendaja(new$new, "manager", "", replace = "juht")
new$new = asendaja(new$new, "^konstruktor$", "", replace = "ehitustehnik")
new$new = asendaja(new$new, "^põllumajandus$", "", replace = "põllumajandustöötaja")
new$new = asendaja(new$new, "^hooldejuht$", "", replace = "hooldusjuht")
...
new$new = asendaja(new$new, "^üksusejuhataja$", "", replace = "osakonnajuhataja")
...
ISCO = readxl::read_xlsx("~/.gvpers/new_ISCO.xlsx", sheet = "XXXX") %>% 
  mutate(XXX_code = strtrim(XXXX_code,3)) %>% 
  left_join(readxl::read_xlsx("~/.gvpers/new_ISCO.xlsx", sheet = "XXX") %>% mutate(XXX_code = as.character(XXX_code)), by = "XXX_code") %>%
  mutate(XX_code =  strtrim(XXXX_code,2)) %>% 
  left_join(readxl::read_xlsx("~/.gvpers/new_ISCO.xlsx", sheet = "XX") %>% mutate(XX_code = as.character(XX_code)), by = "XX_code") %>%
  mutate(X_code = strtrim(XXXX_code,1)) %>% 
  left_join(readxl::read_xlsx("~/.gvpers/new_ISCO.xlsx", sheet = "X") %>% mutate(X_code = as.character(X_code)), by = "X_code") %>%
  mutate(XXX_name = ifelse(is.na(XXX_name), XXXX_name, XXX_name)) %>%
  mutate(XX_name = ifelse(is.na(XX_name), XXX_name, XX_name))

new_isco = left_join(new, ISCO, by = "new")

new_isco = new_isco %>% 
  left_join(new_isco %>% pull(new) %>% table %>% as.data.frame  %>% `names<-`(c("new","new_count")), by="new") %>%
  left_join(new_isco %>% pull(XXX_code) %>% table %>% as.data.frame %>% `names<-`(c("XXX_code","XXX_count")), by="XXX_code") %>%
  left_join(new_isco %>% pull(XX_code) %>% table %>% as.data.frame %>% `names<-`(c("XX_code","XX_count")), by="XX_code")

new_isco = new_isco %>% filter(new_count >= 25)

### Which ones are less than 100?

table(new_isco$new) %>% .[. < 100]
