...
new$new = asendaja(new$new, "koolijuht", "", excl1 = "õpetaja;", replace = "haridusasutustejuhid")
...
new$new = asendaja(new$new, "tantsuõpe", "", excl1 = "keeleteh", excl2 = "kontor", replace = "tantsuõpetaja")
