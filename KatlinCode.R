...
new$new = asendaja(new$new, "^keskusejuhataja$", "", replace = "juht")
...
write_xlsx(list(unitg_count = unitg_count, minorg_count = minorg_count), path = "C:/Users/K/Google Drive/GV/sizesofgroups.xlsx")
