...
new$new = asendaja(new$new, "koristaja", "", excl1 = "juht", excl2 = "kliendi", excl3 = "objekt", excl4 = "müüja",  replace = "puhastusteenindaja")
...
new$new = asendaja(new$new, "kommunikatsiooni", "juh", excl1 = "müügi", excl2 = "omanik", excl3 = "äriarendus", "telekomm", replace = "reklaamijuht")
...
new$new = asendaja(new$new, "laen", "abi", replace = "laenuhaldur")
