...
new$new = asendaja(new$new, "pearaamatupidaja-", "pea", replace = "pearaamatupidaja")
...
unique(leidur(new$new, "tarkvara", "arendaja"))
...
# mulle tundub siin liiga eripalgeline seltskond, mõtlen hiljem 
