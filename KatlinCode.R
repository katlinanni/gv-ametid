...
new$new = asendaja(new$new, "doktorant", "järel", replace = "teadur")
...
new$new = asendaja(new$new, "huvikoolikeeleõpetaja", "", replace = "huvikoolikeeleõpetaja")
...
new$new = asendaja(new$new, "õpetaja", "muusik", excl1 = "kooli", excl2 = "pastor", replace = "muusikaõpetaja")
...
new$new = asendaja(new$new, "juht", "veoki", replace = "autojuht")
new$new = asendaja(new$new, "juht", "betoonipumba", replace = "autojuht")
...
new$new = asendaja(new$new, "mikroettev", "juh", replace = "väikeettevõttejuht")
...
#siin järgmises on nii elektriseadmete mehaanikud (7412) kui ka elektroonikamehhaanikud (7421) - ei suuda vahet teha
...
new$new = asendaja(new$new, "kodumas", "meh", replace = "elektromehhaanik")
new$new = asendaja(new$new, "kodumas", "meh", replace = "elektromehhaanik")
new$new = asendaja(new$new, "lif", "meh", replace = "elektromehhaanik")
...
new$new = asendaja(new$new, "sõidukimeh", "", excl1 = "juh", replace = "automehhaanik-lukksepp")
...
new$new = asendaja(new$new, "asjaajam", "", replace = "kontorijuhataja")
...
new$new = asendaja(new$new, "oper", "smd", replace = "elektriseadmetekoostaja")
...
new$new = asendaja(new$new, "raamatupida", "ekspert", replace = "pearaamatupidaja")
...
new$new = asendaja(new$new, "kliendit", "panga", replace = "pangateller")
...
new$new = asendaja(new$new, "osakonna", "juhataja", "tugit", replace = "sotsiaalteenustejuht")
new$new = asendaja(new$new, "osakonna", "juhataja", "sotsiaal", replace = "sotsiaalteenustejuht")
new$new = asendaja(new$new, "osakonna", "juhataja", "noorsoot", replace = "sotsiaalteenustejuht")
...
new$new = asendaja(new$new, "", "õigusettevõttejuht", replace = "kutseteenustejuht")
...
new$new = asendaja(new$new, "paigaldusjuht", "", replace = "tööstusetootmisjuht")
new$new = asendaja(new$new, "tehnikajuht", "", replace = "tööstusetootmisjuht")
...
new$new = asendaja(new$new, "vastavuskontrollijuh", "", replace = "jurist")
...
new$new = asendaja(new$new, "elektrisead", "monteer", replace = "elektriseadmete koostaja")
...
new$new = asendaja(new$new, "geofüüsik", "", replace = "geofüüsik")
