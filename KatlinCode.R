...
# järeldoktorandid teaduriteks hoopis?
...
new$new = asendaja(new$new, "neurol", "juh", replace = "arst-juht")
...
# kas eristada müüjatest "müüja-kassapidajad"? Kassapidajad harutan allpool lahti
...
new$new = asendaja(new$new, "pedagoog", "eelkool", replace = "algkooliõpetaja")
...
new$new = asendaja(new$new, "kooli", "direktor", excl1 = "õpetaja;", replace = "haridusasutustejuht")
...
new$new = asendaja(new$new, "pedagoog", "koolieel", replace = "lasteaiaõpetaja")
...
new$new = asendaja(new$new, "õpetaja", "muusika", excl1 = "kooli", excl2 = "pastor", replace = "muusikaõpetaja")
...
new$new = asendaja(new$new, "õpetajaassist", "", replace = "abiõpetaja")
...
new$new = asendaja(new$new, "bussija", "", replace = "bussijuht")
new$new = asendaja(new$new, "trolli", "", excl1 = "kontroll", excl2 = "perena", replace = "bussijuht")
...
# kas kõik, kes kaitseliidus töötavad sobivad sõjaväelasteks?
...
unique(leidur(new$new, "kokk", ""))
# siin on veel pusimist, teen seda allpool
...
new$new = asendaja(new$new, "autolukk", "", replace = "automehhaanik-lukksepp")
...
new$new = asendaja(new$new, "õigus", "nõunik", replace = "jurist")
...
# tarkvarakonsultandis kahtlen, panin "süsteemikonsultandi" järgi
...
# lihtsalt arhitektid ka ilmselt ehitusarhitektid, aga liiga palju välistusi peab tegema
...
unique(leidur(new$new, "kommunikatsiooni", "dir"))
new$new = asendaja(new$new, "kommunikatsiooni", "dir", replace = "reklaamijuht")
...
new$new = asendaja(new$new, "kommunikatsiooni", "ekspert", replace = "kommunikatsioonispetsialist")
...
new$new = asendaja(new$new, "investor","", excl1 = "head", excl2 = "juhtiv", excl3 = "suhete", replace = "investor")
...
new$new = asendaja(new$new, "arhiiv", "pedagoog", replace = "pedagoogikatippspetsialist")
...
new$new = asendaja(new$new, "infospetsialist", "", excl1 = "karjäär", replace = "infopunkti klienditeenindaja")
new$new = asendaja(new$new, "info", "klienditee", replace = "infopunkti klienditeenindaja")
new$new = asendaja(new$new, "klienditoe", "kons", replace = "infopunkti klienditeenindaja")
new$new = asendaja(new$new, "klienditoe", "haldur", replace = "infopunkti klienditeenindaja")
new$new = asendaja(new$new, "klienditoe", "haldur", replace = "infopunkti klienditeenindaja")
new$new = asendaja(new$new, "klienditoe", "spets", replace = "infopunkti klienditeenindaja")
new$new = asendaja(new$new, "infotöötaja", "", excl1 = "sadul", replace = "infopunkti klienditeenindaja")
new$new = asendaja(new$new, "infosekretär", "", replace = "infopunkti klienditeenindaja")
...
new$new = asendaja(new$new, "kliendisuhete", "juht", replace = "reklaamispetsialist")
new$new = asendaja(new$new, "loovjuht", "", excl1 = "õpetaja", replace = "reklaamispetsialist")

table(leidur(new$new, "abi", "arst"))
new$new = asendaja(new$new, "abiarst", "", excl1 = "õendus", replace = "üldarst")
...
new$new = asendaja(new$new, "hooldaja", "seadme", replace = "elektroonikaseadmete mehaanik")
new$new = asendaja(new$new, "hooldaja", "sõidu", replace = "elektroonikaseadmete mehaanik")
new$new = asendaja(new$new, "hooldaja", "kohvi", replace = "elektroonikaseadmete mehaanik")
new$new = asendaja(new$new, "hooldaja", "elektr", replace = "elektroonikaseadmete mehaanik")
new$new = asendaja(new$new, "hooldaja", "arvut", replace = "elektroonikaseadmete mehaanik")
new$new = asendaja(new$new, "hooldaja", "kudumis", replace = "elektroonikaseadmete mehaanik") #??
new$new = asendaja(new$new, "hooldaja", "tehnika", replace = "elektroonikaseadmete mehaanik")
...
new$new = asendaja(new$new, "elektroonik", "raadio", replace = "elektroonikatehnik")
new$new = asendaja(new$new, "elektroonik", "juhtiv", replace = "elektroonikatehnik")
new$new = asendaja(new$new, "elektroonik", "spets", excl1 = "menetlus", excl2 = "poolimis", excl3 = "itja", replace = "elektroonikatehnik")
# lihtsalt elektroonikud lähevad ka siia alla, aga liiga palju välistusi peab tegema
...
unique(leidur(new$new, "firma", "oman", ""))
new$new = asendaja(new$new, "firma", "oman", excl1 = "plekk", excl2 = "assis", replace = "ettevõtja")
new$new = asendaja(new$new, "firma", "enda", "", replace = "ettevõtja")
new$new = asendaja(new$new, "firma", "oma", "juh", excl1 = "osak", replace = "ettevõtja")
...
new$new = asendaja(new$new, "ettevõtjaja", "", replace = "ettevõtja")
new$new = asendaja(new$new, "ettevõtja-", "", replace = "ettevõtja")

# fie-d on end juba rohkem valdkonniti kirjeldanud - kas raamatupidaja-fie nimetada raamatupidajaks või fieks?
# muidugi on ka ilma täpsustuseta fie-sid
...
unique(leidur(new$new, "sekretär", ""))
new$new = asendaja(new$new, "sekretär", "dir", replace = "juhiabi")
...
# siin on veel erinevaid sekretäre, aga rohkem ei oska eristada - kas juhtiv/pea/vastutavad sekretärid peaks kuidagi eraldi jaotama? ISCO-s seda tehtud pole
unique(leidur(new$new, "sekretär", ""))
...
new$new = asendaja(new$new, "klienditeenendaja", "kau", excl1 = "raamat", replace = "müüja")
new$new = asendaja(new$new, "klienditeenendaja", "poe", replace = "müüja")
new$new = asendaja(new$new, "klienditeenendaja", "müü", replace = "müüja")

new$new = asendaja(new$new, "klienditeenendaja", "", replace = "klienditeenindaja")
...
new$new = asendaja(new$new, "klenditeenindaja", "", replace = "klienditeenindaja")
...
new$new = asendaja(new$new, "müüjaja", "", replace = "müüja")
...
### masinaoperaatorid 
#unique(leidur(new$new, "masin", "oper"))
...
# raske eristada, kas hooldusinsener/hooldustehnik on "masinaehitustehnik" või "tehnikahooldusinsener"
