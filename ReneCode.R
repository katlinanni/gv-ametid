...
## Replace non-job words and some common spelling mistakes
...
checked = tibble(checked$row,checked$suggestion) %>% `names<-`(c("row","suggestion"))
new$row = 1:nrow(new)
new = left_join(new, checked, by = "row") %>% select(-row)
new$dist = stringsim(new$new, new$suggestion)
new %>% filter(dist >= .85) %>% arrange(dist) %>% slice(1:20)
...
new = left_join(new, checked, by = "row") %>% select(-row)
new$dist = stringsim(new$new, new$suggestion)
new %>% filter(dist >= .90) %>% arrange(dist) %>% slice(1:20)
...
# järeldoktorandid tegin teaduriteks (N = 8)
unique(leidur(new$new, "doktorant", ""))
new$new = asendaja(new$new, "doktor", "post", replace = "teadur")
new$new = asendaja(new$new, "doktorant", "", excl1 = "nooremteadur", excl2 = "järel", excl3 = "ämmaemand", excl4 = "biokee", replace = "doktorant")
...
new$new = asendaja(new$new, "^ode$","", replace = "meditsiiniõde")
...
new$new = asendaja(new$new, "ôendusjuht","", replace = "õendusjuht")
...
new$new = asendaja(new$new, "hooldus", "ode", replace = "hooldusõde")
...
new$new = asendaja(new$new, "eriarst","", excl1 = "abi", excl2 = "hamba", replace = "eriarst")
...
new$new = asendaja(new$new, "embrüoloog","", replace = "eriarst")
new$new = asendaja(new$new, "epidemioloog","", replace = "eriarst")
new$new = asendaja(new$new, "oftalmoloog","", replace = "eriarst")
new$new = asendaja(new$new, "^patoloog$","", replace = "eriarst")
...
new$new = asendaja(new$new, "rehabilitatsioonikeskusejuh", "", replace = "tervishoiuteenustejuht")
new$new = asendaja(new$new, "perearst", "juh", replace = "tervishoiuteenustejuht")
...
new$new = asendaja(new$new, "ortod","abi", replace = "muu tervishoiuhooldustöötaja")
...
unique(leidur(new$new, "tootmis", "ettevõ", "juh"))
new$new = asendaja(new$new, "tootmis", "ettevõt", "juh", excl1 = "kvaliteedijuht", excl2 = "itbüroo", replace = "tööstusjuht")
new$new = asendaja(new$new, "vabrik", "juh", replace = "tööstusjuht")

unique(leidur(new$new, "registri", "spets"))
...
new$new = asendaja(new$new, "abiprofessor","", replace = "professor")
...
new$new = asendaja(new$new, "õppe-jateadusassistent", "", replace = "õppejõud")
...
new$new = asendaja(new$new, "projectfinanceaccountant", "", replace = "pearaamatupidaja")
...
new$new = asendaja(new$new, "müüja", "vanem", "", excl1 = "laojuhataja", excl2 = "vahetus", replace = "müüja")
...
new$new = asendaja(new$new, "refleksoloog", "", replace = "massöör")
...
new$new = asendaja(new$new, "^asendusõpetaja$", "", replace = "põhikooliõpetaja")
...
new$new = asendaja(new$new, "õppeprorektor", "", excl1 = "nõunik", replace = "haridusasutustejuht")
new$new = asendaja(new$new, "ülikooliprorektor", "", replace = "haridusasutustejuht")
...
new$new = asendaja(new$new, "lasteaednik", "", replace = "lasteaiaõpetaja")
...
new$new = asendaja(new$new, "viiul", "õpetaja", excl1 = "erso", excl2 = "mängija", replace = "muusikakooliõpetaja")
...
new$new = asendaja(new$new, "vokaalõpetaja", "", replace = "muusikaõpetaja")
...
new$new = asendaja(new$new, "õpabi", "", replace = "abiõpetaja")
...
new$new = asendaja(new$new, "", "^teetööline$", replace = "ehitustööline")
...
new$new = asendaja(new$new, "paadiehitaja", "", replace = "puusepp")
new$new = asendaja(new$new, "ehituspuusepp", "", replace = "puusepp")
...
new$new = asendaja(new$new, "kohtu", "juht", replace = "kõrgem valitsusametnik")
new$new = asendaja(new$new, "^politseijuht$", "", replace = "kõrgem valitsusametnik")
...
new$new = asendaja(new$new, "patendivolinik", "", replace = "advokaat-prokurör")
...
new$new = asendaja(new$new, "full-stackdeveloper", "", replace = "veebiprogrammeerija")
new$new = asendaja(new$new, "webmaster", "", replace = "veebiprogrammeerija")
...
new$new = asendaja(new$new, "^itinsener$", "", replace = "programmeerija")
new$new = asendaja(new$new, "tarkvarainserner", "", replace = "programmeerija")
new$new = asendaja(new$new, "rakenduseadministraator", "", replace = "programmeerija")
new$new = asendaja(new$new, "rakendusadministraator", "", replace = "programmeerija")
new$new = asendaja(new$new, "infosüsteemidearendaja", "", replace = "programmeerija")
...
new$new = asendaja(new$new, "süsteemiarend", "", replace = "süsteemianalüütik")
new$new = asendaja(new$new, "süsteemiinse", "", replace = "süsteemianalüütik")
new$new = asendaja(new$new, "it-konsultant", "", replace = "süsteemianalüütik")
new$new = asendaja(new$new, "informaatik", "", excl1 = "geo", excl2 = "bio", replace = "süsteemianalüütik")
new$new = asendaja(new$new, "^ärianalüütik$", "", replace = "süsteemianalüütik")
new$new = asendaja(new$new, "infohald", "", replace = "infohaldur")
...
new$new = asendaja(new$new, "it", "tootejuht", replace = "süsteemianalüütik")
...
new$new = asendaja(new$new, "tarkvaraspetsialist", "", replace = "süsteemianalüütik")
...
new$new = asendaja(new$new, "saaliteenindaja", "", replace = "ettekandja")
new$new = asendaja(new$new, "sommeljee", "", replace = "ettekandja")
new$new = asendaja(new$new, "hommikusöögiteenindaja", "", replace = "ettekandja")

unique(leidur(new$new, "tõlkija", ""))
unique(leidur(new$new, "keele", "toimetaja"))
new$new = asendaja(new$new, "tõlkija", "", excl1 = "giid", replace = "filoloog")
...
new$new = asendaja(new$new, "noortejuht", "", replace = "sotsiaaltöötaja")
new$new = asendaja(new$new, "sotsiaalhoolekandetöötaja", "", replace = "sotsiaaltöötaja")
new$new = asendaja(new$new, "noorteinstrukt", "", replace = "sotsiaaltöötaja")
new$new = asendaja(new$new, "kriminaalametnik", "", replace = "sotsiaaltöötaja")
new$new = asendaja(new$new, "töövõimehindamisespetsialist", "", replace = "sotsiaaltöötaja")
...
new$new = asendaja(new$new, "kuulmisnõustaja", "", replace = "logopeed")
...
new$new = asendaja(new$new, "kaubatundja", "", replace = "müügiesindaja")
...
new$new = asendaja(new$new, "spets", "andmeb", replace = "andmebaasianalüütik")
new$new = asendaja(new$new, "andmeaidaarendaja", "", replace = "andmebaasianalüütik")
new$new = asendaja(new$new, "dataengineer", "", replace = "andmebaasianalüütik")
new$new = asendaja(new$new, "e-ressurss", "", replace = "andmebaasianalüütik")
new$new = asendaja(new$new, "andmehald", "spets", replace = "andmebaasianalüütik")
new$new = asendaja(new$new, "andmespetsialist", "", replace = "andmesisestaja")
new$new = asendaja(new$new, "andmetespetsialist", "", replace = "andmesisestaja")
new$new = asendaja(new$new, "andmekogudespets", "", replace = "andmesisestaja")
new$new = asendaja(new$new, "infosüsteemihaldur", "", replace = "andmebaasianalüütik")
...
new$new = asendaja(new$new, "üksuseülem", "", replace = "sõjaväelane")
new$new = asendaja(new$new, "veebel", "", replace = "sõjaväelane")
new$new = asendaja(new$new, "staabiülem", "", replace = "sõjaväelane")
new$new = asendaja(new$new, "kompaniiülem", "", replace = "sõjaväelane")
new$new = asendaja(new$new, "rühmaülem", "", replace = "sõjaväelane")
new$new = asendaja(new$new, "rühmavanem", "", excl1 = "toote", replace = "sõjaväelane")
new$new = asendaja(new$new, "^kadett$", "", replace = "sõjaväelane")
new$new = asendaja(new$new, "^jaoskonnaülem$", "", replace = "sõjaväelane")
...
new$new = asendaja(new$new, "õppe", "juh", excl1 = "grup", excl2 = "õppejõud", excl3 = "toitlustus", excl4 = "dotsent",  replace = "haridusasutustejuht")
...
new$new = asendaja(new$new, "hoold", "töötaja", excl1 = "tee", excl2 = "turva", excl3 = "tervishoiu", replace = "hooldaja")
...
new$new = asendaja(new$new, "sanitar", "", replace = "hooldaja")
...
new$new = asendaja(new$new, "^ehitus-spetsialist$", "", replace = "ehitaja")
new$new = asendaja(new$new, "^ehitusspetsialist$", "", replace = "ehitaja")
...
new$new = asendaja(new$new, "ventilatsioonipaigaldaja", "", replace = "torulukksepp")
...
new$new = asendaja(new$new, "personalijuht", "fina", replace = "finantsjuht")
new$new = asendaja(new$new, "personalijuht", "ettevõttekaasomanik", replace = "ettevõtja")
new$new = asendaja(new$new, "personalijuht", "", excl1 = "sekretär", excl2 = "büroo", excl3 = "kvaliteedi", excl4 = "jurist", replace = "personalijuht")
new$new = asendaja(new$new, "personalipartner", "", replace = "personalijuht")
new$new = asendaja(new$new, "hr", "partner", replace = "personalijuht")
new$new = asendaja(new$new, "hr", "head", replace = "personalijuht")
new$new = asendaja(new$new, "hr", "manager", excl1 = "support", replace = "personalijuht")
new$new = asendaja(new$new, "hr", "juht", replace = "personalijuht")
new$new = asendaja(new$new, "hr", "general", replace = "personalijuht")
new$new = asendaja(new$new, "mangerhr&payroll", "", replace = "personalijuht")
...
new$new = asendaja(new$new, "finantsjuh", "", excl1 = "abi", excl2 = "praktikal", excl3 = "ettevõtte", replace = "finantsjuht")
...
new$new = asendaja(new$new, "kontiiter", "", replace = "pagar-kondiiter")
...
new$new = asendaja(new$new, "toitlustusjuht", "", excl1 = "rekreatsioon", replace = "peakokk")
...
new$new = asendaja(new$new, "arvutiinsener", "", replace = "elektroonikainsener")
...
new$new = asendaja(new$new, "näitleja", "", excl1 = "teatriliidu", excl2 = "nõudepesija", excl3 = "laulja", excl4 = "rekvisiitor", replace = "näitleja")
...
new$new = asendaja(new$new, "organist", "", replace = "muusik")
new$new = asendaja(new$new, "interpreet", "", replace = "muusik")
new$new = asendaja(new$new, "muusikajuht", "", replace = "muusik")
new$new = asendaja(new$new, "transkribeerija", "", replace = "muusik")
...
new$new = asendaja(new$new, "laoarvest", "", replace = "laoametnik")
new$new = asendaja(new$new, "laopidaja", "", replace = "laoametnik")
new$new = asendaja(new$new, "laoametnik", "", replace = "laoametnik")
new$new = asendaja(new$new, "laokordinaator", "", replace = "laoametnik")
new$new = asendaja(new$new, "laomeister", "", replace = "laoametnik")
new$new = asendaja(new$new, "^logistikaabi$", "", replace = "laoametnik")
new$new = asendaja(new$new, "^logistikuabi$", "", replace = "laoametnik")
...
new$new = asendaja(new$new, "laoülem", "", replace = "laojuhataja")
...
new$new = asendaja(new$new, "metsamajanduseinsener", "", replace = "metsandusspetsialist")
new$new = asendaja(new$new, "metsandusnõunik", "", replace = "metsandusspetsialist")
...
new$new = asendaja(new$new, "metsandustööline", "", replace = "metsatööline")
...
new$new = asendaja(new$new, "ombleja", "", replace = "õmbleja")
new$new = asendaja(new$new, "meisterõmblusvabrikus", "", replace = "õmbleja")

new$new = asendaja(new$new, "juurdelõikaja", "", excl1 = "rätsep", excl2 = "kunstnik", replace = "juurdelõikaja")
new$new = asendaja(new$new, "rõiva", "konstruktor", "", replace = "juurdelõikaja")
new$new = asendaja(new$new, "rätsep", "", excl1 = "tipp", excl2 = "juurdelõikaja-", replace = "rätsep")
new$new = asendaja(new$new, "^modist", "", replace = "rätsep")
...
new$new = asendaja(new$new, "skulptor", "", replace = "kunstnik")
new$new = asendaja(new$new, "^paberirestauraatorkeeleõpetaja$", "", replace = "kunstnik")
new$new = asendaja(new$new, "^illustrator$", "", replace = "kunstnik")
...
new$new = asendaja(new$new, "tarnejuht", "", replace = "tarneahelajuht")
...
new$new = asendaja(new$new, "jaamakorraldaja", "", replace = "logistik")
...
unique(leidur(new$new, "kvaliteed", "juh", excl1 = "abi"))
new$new = asendaja(new$new, "kvaliteedi", "juh", excl1 = "abi", excl2 = "lagede", replace = "kvaliteedijuht")
...
new$new = asendaja(new$new, "helidisainer", "", replace = "audiovisuaaltehnik")
new$new = asendaja(new$new, "heliinsener", "", replace = "audiovisuaaltehnik")
...
new$new = asendaja(new$new, "elektr", "meh", excl1 = "ittugi", excl2 = "elektroonika", excl3 = "tehnik", replace = "elektromehaanik")
...
new$new = asendaja(new$new, "elektriala", "", replace = "elektrik")
new$new = asendaja(new$new, "elektritöödespets", "", replace = "elektrik")

unique(leidur(new$new, "spetsialist", "ostu"))
new$new = asendaja(new$new, "spetsial", "ostu", replace = "hankespetsialist")
...
new$new = asendaja(new$new, "tellimustehaldur", "", replace = "hankespetsialist")
new$new = asendaja(new$new, "varustusspetsialist", "", replace = "hankespetsialist")
new$new = asendaja(new$new, "hankehaldur", "", replace = "hankespetsialist")
new$new = asendaja(new$new, "tarneahelaplaneerija", "", replace = "hankespetsialist")
new$new = asendaja(new$new, "ostuinsener", "", replace = "hankespetsialist")
new$new = asendaja(new$new, "tellimuste", "koordin", replace = "hankespetsialist")
...
new$new = asendaja(new$new, "arhiivsetedokumentiderahv", "", replace = "andmesisestaja")
new$new = asendaja(new$new, "kaubasisestaja", "", replace = "andmesisestaja")
...
new$new = asendaja(new$new, "statistik", "", excl1 = "osakond", excl2 = "toimetaja", excl3 = "küsitleja", replace = "andmeteadur")
...
new$new = asendaja(new$new, "andmeanalüü", "spets",replace = "andmeteadur")
...
new$new = asendaja(new$new, "hooldusmehaanik", "", replace = "automehaanik-lukksepp")
new$new = asendaja(new$new, "hooldemeister", "", replace = "automehaanik-lukksepp")
new$new = asendaja(new$new, "^hooldusmeister$", "", replace = "automehaanik-lukksepp")
new$new = asendaja(new$new, "^autoremont$", "", replace = "automehaanik-lukksepp")
new$new = asendaja(new$new, "^remondimehaanik$", "", replace = "automehaanik-lukksepp")
...
new$new = asendaja(new$new, "keevitja", "", replace = "keevitaja")

unique(leidur(new$new, "luksepp", "", ""))
new$new = asendaja(new$new, "luksepp", "",replace = "lukksepp")
new$new = asendaja(new$new, "lukksep", "remondi",replace = "remondilukksepp")
...
new$new = asendaja(new$new, "masinaoperaator", "", excl1 = "pesu", excl2 = "foto", replace = "masinaoperaator")
new$new = asendaja(new$new, "operaator", "masin", excl1 = "pesu", excl2 = "foto", replace = "masinaoperaator")
...
unique(leidur(new$new, "raamatupi", "tööt"))
...
new$new = asendaja(new$new, "arveldustöötaja", "", replace = "raamatupidamisekontoritöötaja")
new$new = asendaja(new$new, "arvepidaja", "", replace = "raamatupidamisekontoritöötaja")
new$new = asendaja(new$new, "arvesisestaja", "", replace = "raamatupidamisekontoritöötaja")
...
new$new = asendaja(new$new, "financialspecialist", "",  replace = "raamatupidamisespetsialist")
new$new = asendaja(new$new, "finantsosakonnaspetsialist", "",  replace = "raamatupidamisespetsialist")
...
new$new = asendaja(new$new, "eelarvestaja", "", replace = "ehitustehnik")

new$new = asendaja(new$new, "eelarvest", "", excl1 = "juh", excl2 = "tehnoloog", replace = "raamatupidamisespetsialist")
...
new$new = asendaja(new$new, "pearaamtupi", "", replace = "pearaamatupidaja")
new$new = asendaja(new$new, "finantsosakonnapeaspetsialist", "", replace = "pearaamatupidaja")

new$new = asendaja(new$new, "personali", "arvest", excl1 = "raamatupidajap", excl2 = "juht", replace = "personalitöötaja")
new$new = asendaja(new$new, "personali", "töötaja", excl1 = "raamatupid", excl2 = "sekretär", excl3 = "raamtu", replace = "personalitöötaja")
new$new = asendaja(new$new, "kaadri", "töötaja", replace = "personalitöötaja")
new$new = asendaja(new$new, "personalitöö$", "", replace = "personalitöötaja")
...
new$new = asendaja(new$new, "", "gisspetsialist", replace = "maamõõtja")
new$new = asendaja(new$new, "^gis$", "", replace = "maamõõtja")
new$new = asendaja(new$new, "^maanõunik$", "", replace = "maamõõtja")
new$new = asendaja(new$new, "^maaspetsialist$", "", replace = "maamõõtja")
new$new = asendaja(new$new, "^maakorraldusspetsialist$", "", replace = "maamõõtja")
...
new$new = asendaja(new$new, "suurkliendihaldurpangas", "", replace = "finantsnõustaja")
new$new = asendaja(new$new, "finantskonsultant", "", replace = "finantsnõustaja")
new$new = asendaja(new$new, "finantsabi", "", replace = "finantsnõustaja")
new$new = asendaja(new$new, "^krediidijuht$", "", replace = "finantsnõustaja")
new$new = asendaja(new$new, "^investeeringutejuht$", "", replace = "finantsnõustaja")
...
new$new = asendaja(new$new, "koristaja", "", excl1 = "juh", excl2 = "kliendi", excl3 = "objekt", excl4 = "müüja",  replace = "puhastusteenindaja")
...
new$new = asendaja(new$new, "kodukoristus", "", replace = "puhastusteenindaja")
new$new = asendaja(new$new, "koristusteenindaja", "", replace = "puhastusteenindaja")
new$new = asendaja(new$new, "puhastustöö", "", excl1 = "juh", replace = "puhastusteenindaja")
...
new$new = asendaja(new$new, "menetleja", "väärt",  replace = "õigusekeskastmespetsialist")
...
new$new = asendaja(new$new, "riidepoeomanik", "", replace = "kauplusejuhataja")
...
new$new = asendaja(new$new, "kaubakatekooriajuht", "", replace = "hankespetsialist")
...
new$new = asendaja(new$new, "majutusadmin", "", replace = "hotelliadministraator")
...
new$new = asendaja(new$new, "sysadmin", "", replace = "süsteemiadministraator")
new$new = asendaja(new$new, "süsadmin", "", replace = "süsteemiadministraator")
new$new = asendaja(new$new, "infosüsteemi", "haldur", replace = "süsteemiadministraator")

unique(leidur(new$new, "itarhitekt", ""))
new$new = asendaja(new$new, "itarhit", "", replace = "programmeerija")
new$new = asendaja(new$new, "it-arhit", "", replace = "programmeerija")
new$new = asendaja(new$new, "itlahend", "arhit", replace = "programmeerija")
new$new = asendaja(new$new, "itsüsteemidearendaja", "", replace = "programmeerija")
new$new = asendaja(new$new, "programmerija", "", replace = "programmeerija")
...
new$new = asendaja(new$new, "töösuhete", "spets", replace = "personalispetsialist")
new$new = asendaja(new$new, "töösuhete", "konsul", replace = "personalispetsialist")
new$new = asendaja(new$new, "hr", "spe", replace = "personalispetsialist")
new$new = asendaja(new$new, "hr", "adm", replace = "personalispetsialist")
new$new = asendaja(new$new, "^hr", "", replace = "personalispetsialist")
new$new = asendaja(new$new, "personaalispets", "", replace = "personalispetsialist")
...
new$new = asendaja(new$new, "tarkvarajuht", "", replace = "IKT-juht")
...
new$new = asendaja(new$new, "büroojuht", "", excl1 = "arendus", excl3 = "sekretär", replace = "kontorijuhataja")
new$new = asendaja(new$new, "kontorijuht", "", excl1 = "kliendi", excl2 = "raamatupidaja", replace = "kontorijuhataja")
new$new = asendaja(new$new, "^büroo", "juht", replace = "kontorijuhataja")
new$new = asendaja(new$new, "strateegiabüroojuht", "", replace = "kontorijuhataja")
...
new$new = asendaja(new$new, "lektor", "", excl1 = "koolitaja", replace = "õppejõud")
new$new = asendaja(new$new, "dotsent", "", replace = "õppejõud")
new$new = asendaja(new$new, "õppejõud", "", excl1 = "juht", excl2 = "õpetajaõppe", replace = "õppejõud")
...
new$new = asendaja(new$new, "disainiinsener", "", replace = "tootedisainer")
new$new = asendaja(new$new, "disainikonsult", "", replace = "tootedisainer")
new$new = asendaja(new$new, "tööstusdisainer", "", replace = "tootedisainer")
new$new = asendaja(new$new, "mööblidisainer", "", replace = "tootedisainer")
new$new = asendaja(new$new, "tehnilinedisainer", "", replace = "tootedisainer")
...
new$new = asendaja(new$new, "sisekontrolör", "", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "rektor", "nõunik", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "andmekaitse", "spets", replace = "juhtimisanalüütik")
...
new$new = asendaja(new$new, "scrummaster", "", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "sisekontroll", "", excl1 = "juh", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "^äriarendaja$", "", replace = "juhtimisanalüütik")
new$new = asendaja(new$new, "business", "develop", excl1 = "manager", replace = "juhtimisanalüütik")

new$new = asendaja(new$new, "audiitor", "", excl1 = "keskk", replace = "audiitor")
new$new = asendaja(new$new, "auditi", "konsultant", replace = "audiitor")
...
new$new = asendaja(new$new, "customersuccessmanager", "", replace = "klienditeenindusjuht")

new$new = asendaja(new$new, "teenindusjuht", "toit", replace = "ettekandja")
new$new = asendaja(new$new, "teenindusjuht", "resto", replace = "ettekandja")
...
new$new = asendaja(new$new, "arborist", "", replace = "aednik")
new$new = asendaja(new$new, "maastikuehitaja", "", replace = "aednik")
new$new = asendaja(new$new, "aiand", "tööline", "", replace = "aednik")
...
new$new = asendaja(new$new, "aretusspetsialist", "", replace = "loomakasvataja")
...
new$new = asendaja(new$new, "valveteenistus", "", replace = "turvatöötaja")
new$new = asendaja(new$new, "valve", "operaator", replace = "turvatöötaja")
...
new$new = asendaja(new$new, "liikluskorraldaja", "", replace = "turvatöötaja")
...
new$new = asendaja(new$new, "juhtõpetaja", "", excl1 = "ettevõtte", replace = "õppemetoodikaspetsialist")
...
new$new = asendaja(new$new, "päästeteenist", "", replace = "päästja")
new$new = asendaja(new$new, "päästeametnik", "", replace = "päästja")
new$new = asendaja(new$new, "kriisi", "", replace = "kriisikoordinaator")
...
new$new = asendaja(new$new, "arhiivitoimetaja", "", replace = "arhivaar-kuraator")
new$new = asendaja(new$new, "digiteerimisspetsialist", "", replace = "arhivaar-kuraator")
...
new$new = asendaja(new$new, "hüdroloog","", replace = "meteoroloog")
...
new$new = asendaja(new$new, "õppetööspetsialist", "", replace = "pedagoogikatippspetsialist")
new$new = asendaja(new$new, "õppemeister", "", replace = "pedagoogikatippspetsialist")
...
new$new = asendaja(new$new, "pakendaja", "", replace = "pakkija")
...
new$new = asendaja(new$new, "koolitusepeaspetsialist", "", replace = "töötajate koolitusspetsialist")
...
new$new = asendaja(new$new, "sillainsener", "", replace = "ehitusinsener")
new$new = asendaja(new$new, "objektiinsener", "", replace = "ehitusinsener")
new$new = asendaja(new$new, "ehitusnõunik", "", replace = "ehitusinsener")
...
new$new = asendaja(new$new, "transform", "valmis", replace = "elektriseadmete koostaja")
new$new = asendaja(new$new, "elektrikomponentidevalmistaja", "", replace = "elektriseadmete koostaja")
...
new$new = asendaja(new$new, "kompleteerija", "", replace = "pakkija")
...
new$new = asendaja(new$new, "koost", "spetsialist", replace = "muudkoostajad")
new$new = asendaja(new$new, "avatäide", "paigald", replace = "puusepp")
new$new = asendaja(new$new, "landivalmistaja", "", replace = "muudkoostajad")
new$new = asendaja(new$new, "monteerija", "", excl1 = "elektr", replace = "muudkoostajad")
new$new = asendaja(new$new, "montaažitööline", "", replace = "muudkoostajad")
new$new = asendaja(new$new, "montaaz", "", replace = "muudkoostajad")
...
new$new = asendaja(new$new, "ehitus-keskkonnaspetsialist", "", replace = "keskkonnanõunik")
new$new = asendaja(new$new, "taimekaitse", "", replace = "keskkonnanõunik")
new$new = asendaja(new$new, "taimetervise", "", replace = "keskkonnanõunik")
new$new = asendaja(new$new, "välisõhu", "spets", replace = "keskkonnanõunik")
new$new = asendaja(new$new, "maapõue", "spets", replace = "keskkonnanõunik")
new$new = asendaja(new$new, "looduskasutusespetsialist", "", replace = "keskkonnanõunik")
new$new = asendaja(new$new, "maahooldus", "spetsialist", replace = "keskkonnanõunik")
...
new$new = asendaja(new$new, "turismi", "konsultant", replace = "reisikonsultant")
new$new = asendaja(new$new, "turismikorraldaja", "", replace = "reisikonsultant")
...
new$new = asendaja(new$new, "info", "töötaja", excl1 = "sadul", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "infosekretär", "", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "infokonsultant", "", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "infokoordinaator", "", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "teabetöötaja", "", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "teenindustoespetsialist", "", replace = "klienditoe konsultant")
...
new$new = asendaja(new$new, "taksaator", "", replace = "hindaja")
new$new = asendaja(new$new, "hinnastaja", "", replace = "hindaja")
new$new = asendaja(new$new, "hinnaspetsialist", "", replace = "hindaja")
new$new = asendaja(new$new, "hinnaanalüütik", "", replace = "hindaja")
new$new = asendaja(new$new, "hinnaarvestaja", "", replace = "hindaja")
...
new$new = asendaja(new$new, "kriminalist", "", replace = "politseiuurija")
...
new$new = asendaja(new$new, "keemik", "", replace = "keemik")
new$new = asendaja(new$new, "biokee", "", replace = "keemik")
...
new$new = asendaja(new$new, "botaanik", "", replace = "bioloog")
new$new = asendaja(new$new, "kliinilisteuuringute", "spets", replace = "bioloog")
new$new = asendaja(new$new, "zooloog", "", replace = "bioloog")
new$new = asendaja(new$new, "bioinformaatik", "", replace = "bioloog")
...
new$new = asendaja(new$new, "aparaadiehitaja", "", replace = "masinaehitustehnik")
new$new = asendaja(new$new, "külmatehnik", "", replace = "masinaehitustehnik")
...
new$new = asendaja(new$new, "esmaabi", "", replace = "kiirabitehnik")
...
new$new = asendaja(new$new, "puutööline", "", replace = "puidutööline")
...
new$new = asendaja(new$new, "brošeerija", "", replace = "trükiettevalmistaja")
new$new = asendaja(new$new, "trükiseadmeteseadistaja", "", replace = "trükiettevalmistaja")
...
new$new = asendaja(new$new, "krediidi", "spets", replace = "laenuhaldur")
new$new = asendaja(new$new, "laenu", "amet", replace = "laenuhaldur")
new$new = asendaja(new$new, "liisinguspetsialist", "", replace = "laenuhaldur")
new$new = asendaja(new$new, "liisinguhaldur", "", replace = "laenuhaldur")
new$new = asendaja(new$new, "investeeringutehaldur", "", replace = "laenuhaldur")
...
new$new = asendaja(new$new, "liiklusõpetaja", "", replace = "sõiduõpetaja")
...
new$new = asendaja(new$new, "meremees", "", replace = "madrus")
...
new$new = asendaja(new$new, "hingehoidja", "", replace = "psühholoog")
...
new$new = asendaja(new$new, "raadiotehnik", "", replace = "elektroonikamehaanik")
...
new$new = asendaja(new$new, "värvija", "", excl1 = "sepp", replace = "tootevärvija")
...
new$new = asendaja(new$new, "^sotsiaaltöö$", "", replace = "sotsiaaltööspetsialist")
new$new = asendaja(new$new, "hoolduspere", "", replace = "sotsiaaltööspetsialist")
new$new = asendaja(new$new, "kovsotsiaalametispetsialist", "", replace = "sotsiaaltööspetsialist")
new$new = asendaja(new$new, "pere", "tugi", replace = "sotsiaaltööspetsialist")
...
new$new = asendaja(new$new, "energia", "konsul", replace = "elektrotehnik")
...
new$new = asendaja(new$new, "inventeerija", "", replace = "laoametnik")
...
new$new = asendaja(new$new, "laudsepp", "", replace = "tisler")
new$new = asendaja(new$new, "^mööblivalmistaja$", "", replace = "tisler")
new$new = asendaja(new$new, "^mööblirestauraator$", "", replace = "tisler")
...
new$new = asendaja(new$new, "customers", "", excl1 = "manager", replace = "klienditoe konsultant")
new$new = asendaja(new$new, "võtmeklient", "haldur", replace = "klienditoe konsultant")
...
new$new = asendaja(new$new, "kauplus", "omanik", replace = "ettevõtja")
new$new = asendaja(new$new, "ettevõtteasutaja", "", replace = "ettevõtja")
new$new = asendaja(new$new, "eraettevotja", "", replace = "ettevõtja")
new$new = asendaja(new$new, "ettevotja", "", replace = "ettevõtja")
new$new = asendaja(new$new, "ettevôtja", "", replace = "ettevõtja")
new$new = asendaja(new$new, "ettev", "osanik", replace = "ettevõtja")
...
new$new = asendaja(new$new, "filmivõttekohatekordinaator", "", replace = "muu kultuurivaldkonna spetsialist")
new$new = asendaja(new$new, "etendus", "juh", replace = "muu kultuurivaldkonna spetsialist")
new$new = asendaja(new$new, "kostüümiala", "juh", replace = "muu kultuurivaldkonna spetsialist")
new$new = asendaja(new$new, "lavastusala", "juh", replace = "muu kultuurivaldkonna spetsialist")
...
new$new = asendaja(new$new, "muruniitja", "", replace = "haljastustööline")
new$new = asendaja(new$new, "kasvuhoonetööline", "", replace = "haljastustööline")
...
new$new = asendaja(new$new, "^ehitamine$", "", replace = "ehitaja")
new$new = asendaja(new$new, "^lammut", "", replace = "ehitaja")
...
new$new = asendaja(new$new, "muuseumiteenindaja", "", replace = "klienditeenindaja")
...
new$new = asendaja(new$new, "", "kontoriametnik", replace = "kontoritöötaja")
new$new = asendaja(new$new, "kontoritööline", "", replace = "kontoritöötaja")
...
new$new = asendaja(new$new, "kauplusetöötaja", "", replace = "müüja")
new$new = asendaja(new$new, "poetöötaja", "", replace = "müüja")
...
new$new = asendaja(new$new, "kasutajatoespetsialist", "", replace = "IKT-tehnik")
new$new = asendaja(new$new, "itteenusehaldur", "", replace = "IKT-tehnik")
new$new = asendaja(new$new, "tehnilisetoeinsener", "", replace = "IKT-tehnik")
...
new$new = asendaja(new$new, "koduabiline", "", replace = "puhastusteenindaja")
new$new = asendaja(new$new, "kahjuritõrjuja", "", replace = "puhastusteenindaja")
...
new$new = asendaja(new$new, "parkimiskorr", "", replace = "muulihttööline")
new$new = asendaja(new$new, "parkla", "", replace = "muulihttööline")
new$new = asendaja(new$new, "publikuteenindaja", "", replace = "muulihttööline")
...
new$new = asendaja(new$new, "^ärikontroller$", "", replace = "pearaamatupidaja")
new$new = asendaja(new$new, "^businesscontroller$", "", replace = "pearaamatupidaja")

unique(leidur(new$new, "raamatupidaja", "", excl1 = "juht"))
new$new = asendaja(new$new, "raamatupidaj", "", excl1 = "juh", excl2 = "pearaamatupidaja", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamatupidamine", "", excl1 = "juh", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamatupidamist", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamatupidamiset", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamatupidja", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamtupidaja", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "ramatupidaja", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "raamatipidaja", "", replace = "raamatupidaja")
...
new$new = asendaja(new$new, "müüja", "", excl1 = "juht", excl2 = "telefonimüüja", excl3 = "vahetusev", replace = "müüja")
new$new = asendaja(new$new, "teenind", "kaup", replace = "müüja")
...
new$new = asendaja(new$new, "^juhatus$", "", replace = "juhatuseliige")
new$new = asendaja(new$new, "^juhatuseesinaine$", "", replace = "juhatuseliige")
new$new = asendaja(new$new, "^juhliige$", "", replace = "juhatuseliige")
new$new = asendaja(new$new, "nõukoguliige", "", replace = "juhatuseliige")
new$new = asendaja(new$new, "^juhtkonnaliige$", "", replace = "juhatuseliige")
new$new = asendaja(new$new, "^juhatuselige$", "", replace = "juhatuseliige")
...
new$new = asendaja(new$new, "^teller$", "", replace = "pangateller")
...
new$new = asendaja(new$new, "kaupmees", "", replace = "müüja")
...
new$new = asendaja(new$new, "kliediteenindaja$", "", replace = "klienditeenindaja")
new$new = asendaja(new$new, "klieenditeenindaja", "", replace = "klienditeenindaja")
...
new$new = asendaja(new$new, "tugikeskuse", "juh", replace = "sotsiaalhoolekandejuht")
...
new$new = asendaja(new$new, "äri", "juh", excl1 = "arendus", replace = "haldusjuht")
...
new$new = asendaja(new$new, "haridusjuht", "", replace = "haridusasutustejuht")
...
new$new = asendaja(new$new, "juriidilise", "valdkonnajuht", replace = "kutseteenustejuht")
...
new$new = asendaja(new$new, "päästekomandopealik", "", replace = "kutseteenustejuht")
...
new$new = asendaja(new$new, "analüütikajuht", "", replace = "IKT-juht")
new$new = asendaja(new$new, "andmehaldusejuht", "", replace = "IKT-juht")
new$new = asendaja(new$new, "andmeteadusejuht", "", replace = "IKT-juht")
new$new = asendaja(new$new, "arvutuskeskusejuhataja", "", replace = "IKT-juht")
...
new$new = asendaja(new$new, "arendusjuht", "", excl1 = "tootearendus", excl2 = "ettevõttejuht", excl3 = "müügi", excl4 = "kinnisvara", replace = "arendusjuht")
new$new = asendaja(new$new, "arengujuht", "", replace = "arendusjuht")
new$new = asendaja(new$new, "teadusjuht", "", replace = "arendusjuht")
new$new = asendaja(new$new, "arendusprorektor", "", replace = "arendusjuht")
new$new = asendaja(new$new, "arendus", "teadus", "juh", replace = "arendusjuht")

new$new = asendaja(new$new, "energeetika", "juh", replace = "tööstusjuht")
...
new$new = asendaja(new$new, "osakonna", "juh", "avalikesuhe", replace = "kommunikatsioonijuht")
new$new = asendaja(new$new, "avalikesuhe", "juht", "", replace = "kommunikatsioonijuht")
new$new = asendaja(new$new, "marketingijuht", "", replace = "reklaamijuht")
...
new$new = asendaja(new$new, "müügi", "juh", excl1 = "meeskonna", excl2 = "projekti", excl3 = "hooldus", excl4 = "tiimi", replace = "müügijuht")
...
new$new = asendaja(new$new, "meedianõunik", "", replace = "reklaamispetsialist")
...
new$new = asendaja(new$new, "projektijuht", "", excl1 = "insener", replace = "projektijuht")
...
new$new = asendaja(new$new, "protsessijuht", "", replace = "tööstuseprotsessijuhtimistehnik")
new$new = asendaja(new$new, "protsessiinsener", "", replace = "tööstuseprotsessijuhtimistehnik")
new$new = asendaja(new$new, "gaasivõrguspetsialist", "", replace = "tööstuseprotsessijuhtimistehnik")
...
new$new = asendaja(new$new, "poliitikakujundaja", "", replace = "strateegiateväljatöötaja")
new$new = asendaja(new$new, "partnerlussuhetejuht", "", replace = "strateegiateväljatöötaja")
...
new$new = asendaja(new$new, "juhiabi-", "", replace = "juhiabi")
new$new = asendaja(new$new, "juhtkonnaabi", "", replace = "juhiabi")
...
new$new = asendaja(new$new, "trüki", "juh", replace = "tööstusjuht")

new$new = asendaja(new$new, "juh", "ehitusettev", excl1 = "projekti", excl2 = "töödejuh", excl3 = "kvaliteedi", replace = "ehitusjuht")

new$new = asendaja(new$new, "oüjuh", "",  replace = "ettevõttejuht")
new$new = asendaja(new$new, "^ettevõtejuht$", "",  replace = "ettevõttejuht")
...
new$new = asendaja(new$new, "ettevõtejuhataja", "",  replace = "ettevõttejuht")
...
new$new = asendaja(new$new, "majandusjuht", "",  replace = "majandusjuhataja")
...
new$new = asendaja(new$new, "koopiakeskusejuhataja", "", replace = "teenustejuht")
...
new$new = asendaja(new$new, "teenindusejuh", "", replace = "teenindusjuht")
new$new = asendaja(new$new, "teenindusejuh", "", replace = "teenindusjuht")
...
new$new = asendaja(new$new, "õmblusjuht", "", replace = "tootmistöödejuhataja")
new$new = asendaja(new$new, "tootmis", "liinijuht", replace = "tootmistöödejuhataja")
...
new$new = asendaja(new$new, "tööjuht", "", excl1 = "kliinil", excl2 = "vastuv", excl3 = "konsul", excl4 = "sotsiaal", replace = "töödejuhataja")
...
new$new = asendaja(new$new, "seltsimaja", "juh", replace = "vabaajakeskustejuht")
new$new = asendaja(new$new, "külakeskusejuhataja", "", replace = "vabaajakeskustejuht")
new$new = asendaja(new$new, "lastekeskusejuhataja", "", replace = "vabaajakeskustejuht")
...
new$new = asendaja(new$new, "keskastmejuht", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "regioonijuht", "", replace = "juht")
new$new = asendaja(new$new, "tippjuht", "", excl1 = "rätsep", replace = "juht")
new$new = asendaja(new$new, "piirkonnajuht", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "asejuht", "", excl1 = "üliõp", replace = "juht")
new$new = asendaja(new$new, "mtüjuh", "", replace = "juht")
new$new = asendaja(new$new, "talitusejuht", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "kesktasemejuht", "", replace = "osakonnajuhataja")
...
new$new = asendaja(new$new, "juriidilinekonsultant", "", replace = "jurist")

new$new = asendaja(new$new, "juht", "klienditeen", replace = "klienditeenindusjuht")
new$new = asendaja(new$new, "klienditeenindusjuht", "", replace = "kontorijuhataja")
new$new = asendaja(new$new, "asjaajamisjuht", "", replace = "kontorijuhataja")
...
new$new = asendaja(new$new, "teehooldusmeister", "", replace = "teemasinajuht")
...
new$new = asendaja(new$new, "covidtestija", "", replace = "muu tervishoiuhooldustöötaja")
new$new = asendaja(new$new, "muutervishoiuhooldus", "", replace = "muu tervishoiuhooldustöötaja")

unique(leidur(new$new, "arsti", "abi"))
new$new = asendaja(new$new, "arsti", "abi", replace = "abiarst")
new$new = asendaja(new$new, "^velsker$", "", replace = "abiarst")
new$new = asendaja(new$new, "^kliinilineabi$", "", replace = "abiarst")
...
new$new = asendaja(new$new, "arhitekt", "tehnik", replace = "ehitustehnik")
...
new$new = asendaja(new$new, "juhtmeköidiste", "", replace = "elektriseadmete koostaja")
...
new$new = asendaja(new$new, "paleontol", "", replace = "geoloog")

unique(leidur(new$new, "hankejuht", ""))
new$new = asendaja(new$new, "hankejuht", "", replace = "hankejuht")
new$new = asendaja(new$new, "tellimustejuht", "", replace = "hankejuht")
new$new = asendaja(new$new, "impordijuht", "", replace = "hankejuht")
...
new$new = asendaja(new$new, "järelevalveinspektor", "", replace = "valitsuse haldusalade ametnik")
new$new = asendaja(new$new, "^järelevalve$", "", replace = "valitsuse haldusalade ametnik")
new$new = asendaja(new$new, "^teostanjärelevalvet$", "", replace = "valitsuse haldusalade ametnik")
new$new = asendaja(new$new, "^priaotsetoetustepeainspektor$", "", replace = "valitsuse haldusalade ametnik")
new$new = asendaja(new$new, "^vallaametnik$", "", replace = "valitsuse haldusalade ametnik")
...
new$new = asendaja(new$new, "teemantpuurija", "", replace = "kivitöötleja")
...
new$new = asendaja(new$new, "maksu", "ametnik", replace = "maksuametnik")
...
new$new = asendaja(new$new, "mtavaneminspektor", "", replace = "maksuametnik")
...
new$new = asendaja(new$new, "kassajuht", "", replace = "müüjate vahetusevanem")
...
new$new = asendaja(new$new, "^karjak", "", replace = "põllumajanduse lihttööline")
...
new$new = asendaja(new$new, "toetustespetsialist", "", replace = "sotsiaalkindlustusametnik")
...
new$new = asendaja(new$new, "^kastipesija$", "", replace = "tööstuselihttööline")
new$new = asendaja(new$new, "^kiletaja$", "", replace = "tööstuselihttööline")
...
new$new = asendaja(new$new, "transporttööline", "", replace = "transporditööline")
...
new$new = asendaja(new$new, "coach", "", replace = "muu nõustaja")
...
new$new = asendaja(new$new, "saalitöötaja", "", replace = "veondustööline")
...
new$new = asendaja(new$new, "tootepaigutaja", "", replace = "veondustööline")
...
new$new = asendaja(new$new, "rekreatsioonikorraldaja", "", replace = "spordiinstruktor")
new$new = asendaja(new$new, "mäesuusainstruktor", "", replace = "spordiinstruktor")
new$new = asendaja(new$new, "matkajuht", "", replace = "spordiinstruktor")
...
new$new = asendaja(new$new, "multimeediaspetsialist", "", replace = "multimeediadisainer")
...
new$new = asendaja(new$new, "^spetsalist", "", replace = "spetsialist")
...
new$new = asendaja(new$new, "^müügiplaneerija", "", replace = "müügiesindaja")
new$new = asendaja(new$new, "^tooteesitleja", "", replace = "müügiesindaja")
new$new = asendaja(new$new, "^tootekonsultant", "", replace = "müügiesindaja")
...
new$new = asendaja(new$new, "konsuldant", "", replace = "konsultant")
new$new = asendaja(new$new, "konsutant", "", replace = "konsultant")
...
new$new = asendaja(new$new, "peaarendaja", "", replace = "arendaja")

new$new = asendaja(new$new, "automaatik", "", excl1 = "juht", replace = "elektromehaanik")
new$new = asendaja(new$new, "elektri", "mootor", replace = "elektromehaanik")
...
new$new = asendaja(new$new, "nooreminsener", "", replace = "insener")
new$new = asendaja(new$new, "vastutavinsener", "", replace = "insener")
new$new = asendaja(new$new, "insener-tehnik", "", replace = "insener")
...
new$new = asendaja(new$new, "^insener", "", replace = "insener")
new$new = asendaja(new$new, "ehitaja", "", excl1 = "laeva", excl2 = "aadi", excl3 = "maastiku", replace = "ehitaja")

table(leidur(new$new, "sekretär", "")) %>% sort(decreasing = T)
new$new = asendaja(new$new, "sekretär", "", excl1 = "meditsiini", replace = "sekretär")
...
new$new = asendaja(new$new, "^liinioperaator$", "", replace = "masinaoperaator")
new$new = asendaja(new$new, "^raamatupidamisespetsialist$", "", replace = "raamatupidaja")
new$new = asendaja(new$new, "^aruandlusspetsialist$", "", replace = "raamatupidaja")
...
new$new = asendaja(new$new, "^masinist$", "", replace = "põllujametsamasinajuht")
...
new$new = asendaja(new$new, "^peadispetšer$", "", replace = "dispetšer")
new$new = asendaja(new$new, "^vanemdišpetser$", "", replace = "dispetšer")
new$new = asendaja(new$new, "^dispetser$", "", replace = "dispetšer")
new$new = asendaja(new$new, "^nounik$", "", replace = "nõunik")
new$new = asendaja(new$new, "^nōunik$", "", replace = "nõunik")
new$new = asendaja(new$new, "^0$", "", replace = "NA")
new$new = asendaja(new$new, "^1000$", "", replace = "NA")
new$new = asendaja(new$new, "^1234$", "", replace = "NA")
new$new = asendaja(new$new, "^erialaspetsialist$", "", replace = "spetsialist")

new$new = asendaja(new$new, "^juhendaja$", "", replace = "superviisor")
...
new$new = asendaja(new$new, "^vanemtehnik$", "", replace = "tehnik")
new$new = asendaja(new$new, "^katsetehnik$", "", replace = "tehnik")
new$new = asendaja(new$new, "^projektikoordinator$", "", replace = "projektikoordinaator")
new$new = asendaja(new$new, "^eestöö", "", replace = "muulihttööline")
new$new = asendaja(new$new, "^digiteerija$", "", replace = "registripidaja")
new$new = asendaja(new$new, "^digitaliseerija$", "", replace = "registripidaja")
new$new = asendaja(new$new, "^assistent$", "", replace = "juhiabi")
new$new = asendaja(new$new, "^administrativeassistant$", "", replace = "juhiabi")
new$new = asendaja(new$new, "^perekonnaseisuametnik$", "", replace = "jurist-asjaajaja")
new$new = asendaja(new$new, "kodeerija", "", replace = "korrektor-kodeerija")
new$new = asendaja(new$new, "^korrektor$", "", replace = "korrektor-kodeerija")
new$new = asendaja(new$new, "teenistusejuhataja", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "^esindusejuhataja$", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "^sektorijuhataja$", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "^countrymanager$", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "^deliverymanager$", "", replace = "müügijuht")
new$new = asendaja(new$new, "^operationsmanager$", "", replace = "müügijuht")
new$new = asendaja(new$new, "^kasvatusõpetaja$", "", replace = "õpetaja")
new$new = asendaja(new$new, "^töökojameister$", "", replace = "meister")
new$new = asendaja(new$new, "^vahetuseülem$", "", replace = "vahetusevanem")
new$new = asendaja(new$new, "^oskustööline.$", "", replace = "oskustööline")

new$new = asendaja(new$new, "^ravimiesitleja", "", replace = "ravimiesindaja")
new$new = asendaja(new$new, "ravim", "konsultant", replace = "ravimiesindaja")
new$new = asendaja(new$new, "tootespetsialistravimitealal", "", replace = "ravimiesindaja")
new$new = asendaja(new$new, "^specialist$", "", replace = "spetsialist")
new$new = asendaja(new$new, "leksikograaf", "", replace = "kirjanik")
...
new$new = asendaja(new$new, "peamenetleja", "",  replace = "litsentsiametnik")
new$new = asendaja(new$new, "vanemmenetleja", "",  replace = "litsentsiametnik")

new$new = asendaja(new$new, "e-poehaldur", "",  replace = "IKT-tehnik")
new$new = asendaja(new$new, "veebihaldur", "",  replace = "IKT-tehnik")
new$new = asendaja(new$new, "veebispetsialist", "",  replace = "IKT-tehnik")

new$new = asendaja(new$new, "tootearendusespetsialist", "",  replace = "tootearendusspetsialist")
new$new = asendaja(new$new, "^kordinaator$", "",  replace = "koordinaator")
new$new = asendaja(new$new, "^koordinator$", "",  replace = "koordinaator")
new$new = asendaja(new$new, "^meistrimees$", "",  replace = "meister")
new$new = asendaja(new$new, "^osakonnameister$", "",  replace = "meister")
...
new$new = asendaja(new$new, "^üksusejuht$", "", replace = "osakonnajuhataja")
new$new = asendaja(new$new, "^üksusejuhataja$", "", replace = "juht")
new$new = asendaja(new$new, "^regioonijuhataja$", "", replace = "juht")
new$new = asendaja(new$new, "^keskusejuh", "", replace = "juht")
new$new = asendaja(new$new, "nõukogujuht", "", replace = "juht")
new$new = asendaja(new$new, "^nõukoguesimees$", "", replace = "juht")
...
new$new = asendaja(new$new, "^podoloog$", "", replace = "muu tervishoiu tippspetsialist")
...
new$new = asendaja(new$new, "^humanitaaraineteõpetaja$", "", replace = "õpetaja")
...
uniqueJobs = table(new$new) %>% .[. == 1] %>% names
uncoded = new %>% filter(new %in% uniqueJobs)
